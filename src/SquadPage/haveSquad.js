          ...
          <div class="col-md-12 content mx-auto konten">
            <div class="col-md-8 mx-auto ">
                ...
                <div class="mt-5 text-center">
                    <h2 class="ml-3 mb-5">Squid Squad<img src={centangbiru} class="img2 ml-2"/></h2>
                    <h3 class="mb-5">ID4R2632379</h3>
                </div>
                <div class="mb-5 pb-5 text-center" style={{ color: "#ed8a90", fontSize: "40px" }}>
              ...
              {/* Info Panel */}
                <div class="row justify-content-center">
                    <div class="col-10 konten1">
                        <div class="row ">
                        <div class="col">
                            <center><a href=""><img src={people} /></a></center>
                            <h1>Anggota</h1>
                        </div>
                        <div class="col">
                            <center><a href=""><img src={fatrows} /></a></center>
                            <h1>Statistik</h1>
                        </div>
                        <div class="col">
                            <center><a href=""><img src={logout} /></a></center>
                            <h1>Keluar</h1>
                        </div>
                        </div>
                    </div>
              ...
              <div class=" col-md-9 mx-auto konten2">
                ...
                <a href=""><img src={search} className="img1"/></a>
                </div>
              </div>
              {/* Akhir Search */}
              {/* Button */}
              <div class="col-md-12 content mx-auto  ">
                <div class="col-md-8 mx-auto ">
                    <div class="d-flex flex-row mx-auto justify-content-between mb-5">
                        <a href=""><button type="button" class="btn btn konten3_btn">Mobile&nbsp;Legend</button></a>
                        <a href=""><button type="button" class="btn btn konten3_btn ml-3">PUBG</button></a>
                        <a href=""><button type="button" class="btn btn konten3_btn">Free&nbsp;Fire</button></a>
                        <a href=""><button type="button" class="btn btn konten3_btn">Point&nbsp;Blank</button></a>
                        <a href=""><button type="button" class="btn btn konten3_btn">Lainnya</button></a>
                    </div>
                </div>
            </div>
              {/* Akhir Button */}
              ...
              <div class="col-md-8 mx-auto mt-5 konten3">
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <img src={foto1} class="img2"/>
                        <div class="mt-3 ml-3">
                        <h1 class="">Squid Squad<img src={centangbiru} class="img2 ml-2"/></h1>
            ...
            {/* <!-- Bottom Navbar --> */}
            <nav class="navbar navbar-dark bg-success navbar-expand bottom ">
